 ...
 */
final class Version20230308183745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE drones (id INT NOT NULL, camera_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, fabriquant VARCHAR(255) NOT NULL, resistance_vent VARCHAR(255) NOT NULL, poids INT NOT NULL, vitesse_horizon INT NOT NULL, vitesse_verticale INT NOT NULL, PRIMARY KEY(id))');
