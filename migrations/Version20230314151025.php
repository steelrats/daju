 ...
 */
final class Version20230314151025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE camera (id INT NOT NULL, ouverture DOUBLE PRECISION NOT NULL, resolution VARCHAR(255) NOT NULL, fov INT NOT NULL, stabilise BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE drones (id INT NOT NULL, camera_id INT NOT NULL, fabriquant_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, resistance_vent VARCHAR(255) NOT NULL, poids INT NOT NULL, vitesse_horizon INT NOT NULL, vitesse_verticale INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE fabriquant (id INT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
